...
pat = re.compile("(?P<month>\w+) (?P<date>\d{1,2}), (?P<year>\d+)", re.IGNORECASE)
...
if __name__ == "__main__":
    ...
    # uncomment the following prints to see results and asserts to test
    # print(f"hashtags are: {matches}") # should be ['cs', 'python', 'LT', 'champions']"
    # assert matches == ['cs', 'python', 'LT', 'champions'], "Incorrect hashtags"
